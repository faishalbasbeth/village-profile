    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <form action="<?php echo base_url(). 'C_Berita/tambah_data_berita'; ?>" method="post">
            <div class="col-md-2 mb-3">
                <label for="firstName">Gambar</label>
                <input name="gambar" type="file" class="form-control" id="firstName" placeholder="" value="" required>
          ...
          <div class="col-md-6 mb-3">
                ...
                <input name="judul" type="text" class="form-control" id="firstName" placeholder="Banjir Melanda KAbupaten Situbondo" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <input name="tgl" type="date" class="form-control" id="firstName" placeholder="Manajer" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-6 mb-3">
                ...
                <textarea name="berita" type="text" class="form-control" id="firstName" placeholder="Banjir Melanda KAbupaten Situbondo" value="" required></textarea>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
