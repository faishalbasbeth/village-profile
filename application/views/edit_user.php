    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          ?>
          <form action="<?php echo base_url(). 'C_User/update_data_user'; ?>" method="post">
          <div class="col-md-2 mb-3">
                <label for="firstName">Nama</label>
                <input name="id_user" type="hidden" class="form-control" id="firstName" placeholder="Kabupaten, Kecamatan, Desa" value="<?php echo $db->id_user ?>" required>
                <input name="nama" type="text" class="form-control" id="firstName" placeholder="Manajer" value="<?php echo $db->nama ?>" required>
              ...
              <div class="col-md-2 mb-3">
                ...
                <input name="password" type="password" class="form-control" id="firstName" placeholder="Manajer" value="<?php echo $db->password ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
