...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      <div class="jumbotron">
        <center><h3>Pembuatan AKTA</h3></center>
        
        <p class="lead">Persyaratan :</p>
        <p class="lead">- Surat Pengantar RT</p>
        <P class="lead">- Surat keterangan lahir (RS/Dokter/Bidan)</P>
        <P class="lead">- Fotokopi legalisir kartu keluarga orang tua</P>
        <p class="lead">- Fotokopi legalisir KTP kedua orang tua</p>
        <P class="lead">- Fotokopi surat nikah/ akta perkawinan orang tua</P>
        <P class="lead">- Fotokopi KTP 2(dua) orang saksi yang mengetahui peristiwa kelahiran</P>
        <center><img src="<?=base_url('assets/images/akta.png')?>"></center>
        <br>
